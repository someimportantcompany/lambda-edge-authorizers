export function renderPage(page: { title: string; description: string; subtext?: string | undefined }): string {
  return /* HTML */ `
    <!DOCTYPE html>
    <html lang="en">
      <head>
...
export function renderErrorPage(err: { message: string; code?: string | undefined }) {
  return renderPage({
